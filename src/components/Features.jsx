      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard
            ...
            title={<>Client Sites</>}
            description="WordPress builds handling custom redirects, viewport-based logic, accessibility fixes, and plugin customization across multiple client projects."
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard
            ...
            title={<>PHP MVC Builds</>}
            description="Custom PHP MVC applications for clients, with hand-built responsive layouts and navigation systems."
          />
        </BentoTilt>
